...
GREETINGS, PROSPECTIVE STUDENT! WELCOME TO THE GREATEST LEARNING INSTITUTION IN THE NEW IMPERIAL COLONIES! ALEXYLVA UNIVERSITY IS RENOWNED ACROSS THE EMPIRE FOR OUR DEVOTION TO STUDENT COMFORT, OUR PIONEERING IN THE FIELDS OF PARATECHNOLOGY, AND OUR TRAVELING FOOTBALL TEAM, THE VICTORIOUS VISIGOTHS. WE HAVE BEEN VISITED ON NUMEROUS OCCASIONS BY BARCA MAGNUS HIMSELF TO EXPRESS APPROVAL OF OUR LONG HISTORY OF ACADEMIC EXCELLENCE AND OUR VAST CONTRIBUTIONS TO THE GLORY OF THE EMPIRE.""")
        await ctx.channel.send(""" OUR VARIOUS TECHNOLOGY DEPARTMENTS ARE RESPONSIBLE FOR MANY OF THE EMPIRE'S MOST USEFUL INNOVATIONS, SUCH AS THE VULCANIC ORBITAL MORTAR, THE STEEL PRAETORS, AND OF COURSE, THE PHITRANSIMUN COMBINE'S ALTERNUS BRIDGES. IN ADDITION TO OUR MORE FAMOUS DEPARTMENTS, WE ALSO PROVIDE STUDENTS WITH NUMEROUS OTHER PATHS OF STUDY, SUCH AS PHILOSOPHY, IMPERIAL HISTORY, AND THE ARTS. WE HAVE GRADUATED THOUSANDS OF STUDENTS WHO WENT ON TO FAITHFULLY SERVE THE EMPIRE, AND YOU TOO CAN BE ONE OF THEM! TAKE YOUR FIRST STEPS AWAY FROM YOUR PATERFAMILIAS AND IMMERSE YOURSELF IN OUR CAMPUS CULTURE, PROTECTED BY OUR VERY OWN FORCE OF CAESARIUM PRAETORS. AT ALEXYLVA UNIVERSITY, GROW YOUR INTELLECTUAL PROWESS AND TAKE ADVANTAGE OF THE MOST ADVANCED COMBINE PRODUCTS AVAILABLE TO THE LARGEST UNIVERSITY IN THE EMPIRE!

MEET OUR GLORIOUS STAFF TRIUMVIRATE
∆ DEAN HAILCLOUD ∆
∆ VICE CHANCELLOR ALLGRASS ∆
∆ HEAD COACH PANAGAKOS ∆
...
MTF RHO-1 ("ΕΠΑΓΓΕΛΜΑΤΙΕΣ")
Designation: Mobile Task Force Rho-1

Nickname: The Professors

Description: Mobile Task Force Rho-1 specializes in the acquisition, containment, and transport of anomalies related to GoI-59, "Alexylva University". With the reduction of the threat posed by the specific GoI, the MTF has expanded its focus to any and all containment for anomalous academic endeavors.

LOGO: https://scp-wiki.wdfiles.com/local--files/groups-of-interest/Alexylva.png""")
    @commands.command(aliases=[])
    async def ambroseresturants(self,ctx):
        await ctx.channel.send("""Overview: Ambrose Restaurants is a large-scale chain of fine-dining eateries, located in various public locations across Earth along with several locations in anomalous or extra-dimensional locations of interest. These restaurants specialize in anomalous food and culinary practices, and vary widely in variation and style. Despite the scale of the Ambrose Restaurants chain, they are generally non-hostile and will instead flee from threats directed towards them.
...
"The world is a strange and wondrous place, and anyone who's visited Three Portland's Jurassic Quarter will know that it's not the most friendly either.""")
        await ctx.channel.send(""" I invite you to let Ambrose be a safe harbour for you to enjoy the unusual delights of the universe without the horror, without the strife, without needing to concern yourself with anything beyond what you order.
...
SCP-3464 by Lt Flops
SCP-4554 by Proasek
SCP-4714 by devonmartin
SCP-4814 by RockTeethMothEyes
SCP-5559-D by Calibold
SCP-5516 by DodoDevil
SCP-5348 by Elunerazim
SCP-5632 by Agente Shuffle
SCP-6074 by CrystalMonarch
SCP-6910 by Penton
...
Email Address: intake@ambrose-restaurants.███1

Footnotes
1. Redacted domain extension contains memetic hazard.""")
        await ctx.channel.send("""

λ-14 DEBRIEFING DOCUMENTS
PRIORITY TARGET:
GOI-116: Ambrose Restaurants
STATUS: ● ACTIVE ●
THREAT LEVEL: ● YELLOW ● (NON-HOSTILE, NORMALCY THREATENING)

Mobile Task Force Lambda-14 ("One Star Reviewers") is a task force which specialises in retail-oriented locations and anomalies, be they singular restaurants or entire shopping districts displaying anomalous properties.
...
Footnotes
1. Due to the use of Saker Units in Anderson’s Workforce, it’s difficult to pinpoint an exact number of employees.
2. Asimov's Lawbringers
3. This not only includes MC&D and the GOC, both of whom have multiple supply contracts with Anderson Robotics, but also the Church of Maxwellism, who hold favorable views of Anderson Robotics products and personnel.

Objects in possession of and/or created by Anderson Robotics:
...
Gyrfalcon Series Prosthetics: First released for consumer sale in 2016, the Gyrfalcon series consists of cybernetic eyes, legs, and arms with a large variety of parahuman abilities and functions. Unlike other Anderson Robotics products, the Gyrfalcon series is offered almost exclusively to customers of Marshall, Carter, and Dark Ltd.

Hobby Personal Android: Standing at 31 cm in height, the Hobby Personal Androids are a series of toy robot prototypes captured by the SCP Foundation during the May 24th, 2024 raid on Anderson Robotic's World Headquarters. Designed to be assembled and programmed by the user, the skill sets present in each unit is dependent on a series of five personality traits selected by the user during construction.
...
MEDIA
1) Anderson Robotics trade logo, circa 1998.
2) Anderson Robotics trade logo, circa 2014.
3) SCP-2806: A prototype Gyrfalcon Series Prosthetic captured by Foundation agents in 2015.""")
        await ctx.channel.send("""
4) SCP-2306: Currently the only known example of the Nankeen Computer Repair System.
5) SCP-1360: An example of a Peregrine Series Humanoid Utility Droid.
https://scp-wiki.wdfiles.com/local--files/anderson-robotics-hub/AndersonLogo1.jpg
https://scp-wiki.wdfiles.com/local--files/anderson-robotics-hub/anderson_robotics_by_sunnyclockwork.png
https://scp-wiki.wdfiles.com/local--files/anderson-robotics-hub/SCP-2806-v2.jpg
https://scp-wiki.wdfiles.com/local--files/anderson-robotics-hub/SCP-2306.png
https://scp-wiki.wdfiles.com/local--files/anderson-robotics-hub/SCP-1360.jpg""")
    @commands.command(aliases=[])
    async def arcadia(self,ctx):
        await ctx.channel.send("""Overview: Defined by highest highs and lowest lows, Arcadia was a rampage through the videogame industry driven by arcane, occult technologies that relied on luck as much as demons; but they made it work. This popularity came at the expense of their customers' exploitation and damnation - without their knowledge, of course. All that slowed to a crawl, however, after the 1983 videogame crash and the otherworld started collecting on unfulfilled promises.
...
Working at Arcadia at this time was a tricky proposition. You never knew whether the gal or guy sitting next to you was a regular employee or a devil worshiper in business attire. The drugs had abated but never truly went away. There was never enough money coming in to make everyone feel comfortable.""")
        await ctx.channel.send(""" The culture was balancing on a knife's edge.
...
Despite their success, nobody within Arcadia knew what or who to attribute it to. Their new management was ruthlessly efficient but paid extremely well. Arcadia itself never quite seemed to have the influence in the public sphere that came from the projects that they completed.""")
        await ctx.channel.send(""" Additionally, the lower-level contracts they had been adjusted to were thrown out in favor of bigger projects that never seemed to be released outside of Arcadia. Rumors were told that Dunn had come back to instill his '85 vision into the new Arcadia. Nothing was ever proven or disproven.
...
Arcadia: The original organization, founded by Nolan Bushnell who loosely led it until 1969, when Bushnell left to work on his own ventures. Originally a high-powered drug-fueled cabal of dark magic users ready and willing to use their magic for fun and profit, it slipped into mundaneness in the late eighties. Reborn in the nineties and the 2000s, modern Arcadia feels like a silent domination - an entirely different Arcadia from the one that openly ruled the video game market with an iron fist.

Prism Products Corporation: Technologic powerhouse founded in the UK and with several operating locations in the USA. Familiar with Arcadia since the 1970s but no official connections until their buyout of Arcadia in 1991. Several PPC personnel and Arcadia employees are acquainted with each other.""")
        await ctx.channel.send(""" Under secret investigation by the UIU for several incidents regarding anomalous technology and biohazards.
